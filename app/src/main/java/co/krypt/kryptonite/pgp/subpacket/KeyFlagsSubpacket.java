...
import static co.krypt.kryptonite.pgp.subpacket.KeyFlagsSubpacket.Flag.AUTHENTICATION;
import static co.krypt.kryptonite.pgp.subpacket.KeyFlagsSubpacket.Flag.CERTIFY_OTHER_KEYS;
import static co.krypt.kryptonite.pgp.subpacket.KeyFlagsSubpacket.Flag.ENCRYPT_COMMUNICATIONS;
import static co.krypt.kryptonite.pgp.subpacket.KeyFlagsSubpacket.Flag.ENCRYPT_STORAGE;
import static co.krypt.kryptonite.pgp.subpacket.KeyFlagsSubpacket.Flag.POTENTIALLY_POSSESSED_BY_MULTIPLE;
import static co.krypt.kryptonite.pgp.subpacket.KeyFlagsSubpacket.Flag.POTENTIALLY_SECRET_SHARED;
import static co.krypt.kryptonite.pgp.subpacket.KeyFlagsSubpacket.Flag.SIGN_DATA;
