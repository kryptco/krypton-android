...
public class SignatureLogRecyclerViewAdapter extends RecyclerView.Adapter<SignatureLogRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.commandText.setText(mValues.get(position).command);
        holder.commandTime.setText(DateUtils.getRelativeTimeSpanString(holder.signatureLog.unixSeconds * 1000));
    }
